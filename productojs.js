const productos = [
  {
    id: '1',
    name: 'Pantalones',
    prodDesc: 'Nuestros pantalones combinan durabilidad, elegancia y calidad en cada costura. Diseñados para brindar comodidad y resistencia, ofrecen un estilo profesional que proyecta confianza, practicidad y una imagen impecable en cualquier entorno laboral.',
    ...
    prodRel: ['id:6', 'id:3', 'id:4', 'id:5']
  },
  {
    id: '2',
    name: 'Camisas y Blusas',
    prodDesc: 'Nuestras camisas y blusas están diseñadas para combinar elegancia, calidad y comodidad en cada detalle. Confeccionadas con telas resistentes que garantizan durabilidad, ofrecen una apariencia impecable incluso en jornadas intensas. Su corte moderno y funcional proyecta una imagen profesional que transmite confianza y estilo.',
    prodC: 'Dependiendo del producto y la selección de telas, se obtienen ventajas únicas como control de humedad, repelencia, propiedades antimanchas y tecnología stretch. Estas características aseguran comodidad, durabilidad y resistencia.',
    ...
    prodRel: ['id:1', 'id:6', 'id:4', 'id:5']
  },
  {
    id: '3',
    name: 'Chalecos',
    prodDesc: 'Nuestros chalecos destacan por su comodidad, durabilidad y elegancia. Confeccionados con materiales resistentes y acabados de calidad, ofrecen un estilo versátil que proyecta profesionalismo en cualquier entorno laboral. Su diseño práctico asegura libertad de movimiento y una imagen impecable que refuerza la identidad corporativa.',
    prodC: 'Dependiendo del producto y la selección de telas, se obtienen ventajas únicas como control de humedad, repelencia, propiedades antimanchas y tecnología stretch. Estas características aseguran comodidad, durabilidad y resistencia.',
    ...
    prodRel: ['id:1', 'id:2', 'id:4', 'id:5']
  },
  {
    id: '4',
    name: 'Chumpas',
    prodDesc: 'Chumpas diseñadas para ofrecer comodidad, durabilidad y elegancia. Con materiales resistentes y acabados de calidad, brindan protección práctica contra el clima, proyectando una imagen profesional impecable y asegurando confianza, estilo y funcionalidad en cada jornada laboral.',
    prodC: 'Dependiendo del producto y la selección de telas, se obtienen ventajas únicas como control de humedad, repelencia, propiedades antimanchas y tecnología stretch. Estas características aseguran comodidad, durabilidad y resistencia.',
    ...
    prodRel: ['id:6', 'id:3', 'id:2', 'id:5']
  },
  {
    id: '5',
    name: 'Polos',
    prodDesc: 'Nuestros polos destacan por su versatilidad, combinando comodidad y calidad en cada detalle. Confeccionados con materiales resistentes que aseguran durabilidad, ofrecen un estilo profesional adaptable a distintos entornos laborales. Su diseño moderno proyecta confianza y practicidad, reforzando la identidad corporativa con una imagen impecable.',
    prodC: 'Dependiendo del producto y la selección de telas, se obtienen ventajas únicas como control de humedad, repelencia, propiedades antimanchas y tecnología stretch. Estas características aseguran comodidad, durabilidad y resistencia.',
    ...
    prodRel: ['id:2', 'id:3', 'id:4', 'id:1']
  },
  {
    id: '6',
    name: 'Restaurantes',
    prodDesc: 'Diseñados para entornos exigentes, nuestros textiles garantizan durabilidad, comodidad y resistencia. Con materiales de alta calidad y acabados impecables, ofrecen protección práctica y una imagen profesional que transmite confianza. Su diseño funcional asegura rendimiento constante y estilo en cada jornada culinaria.',
    prodC: 'Dependiendo del producto y la selección de telas, se obtienen ventajas únicas como control de humedad, repelencia, propiedades antimanchas y tecnología stretch. Estas características aseguran comodidad, durabilidad y resistencia.',
